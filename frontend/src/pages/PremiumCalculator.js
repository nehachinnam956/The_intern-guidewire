...
const DEMO_STORES = [
  { id:'1', name:'Koramangala Dark Store', city:'Bengaluru', risk_score:1.70, risk_label:'HIGH', zone_description:'Flood-prone low-lying area' },
  { id:'2', name:'Andheri West Store', city:'Mumbai', risk_score:1.20, risk_label:'MEDIUM', zone_description:'Coastal humidity zone' },
  { id:'3', name:'Banjara Hills Store', city:'Hyderabad', risk_score:0.90, risk_label:'LOW', zone_description:'Elevated safe zone' },
  { id:'4', name:'Connaught Place Store', city:'Delhi', risk_score:1.40, risk_label:'HIGH', zone_description:'Heat-vulnerable central zone' },
  { id:'5', name:'Kothrud Store', city:'Pune', risk_score:0.75, risk_label:'LOW', zone_description:'Historically safe residential' },
];
...
export default function PremiumCalculator({ rider }) {
  ...
  useEffect(() => {
    storesApi.list().then(r => setStoreList(r.data)).catch(() => {});
  }, []);
